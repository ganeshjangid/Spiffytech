...
<head>
    ...
    <meta name="author" content="https://www.spiffytech.in/">
    <meta name="identifier-url" content="https://www.spiffytech.in/" />
    ...
    <link rel="cononical" href="https://www.spiffytech.in/">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>asserts/css/color/color3.min.css" id='color3' media="screen"/>

    <!--page title-->
  
    
<!--Google Verification code:-  -->
<meta name="google-site-verification" content="XqjEk-LM0-xmDRppB16pBgBonEGexXSp9EJpvRdVP_0" />
...
<body>
    ...
    <!-- color picker end --> 
    <!--header start-->
    <style>.top_strip{background-color: #2B2C7A;height: 32px;}</style>
    <header id="hs_header">
    ...
    <style>
        #hs_logo{margin-top: 0px !important;}
        #hs_header .hs_menu {    
            margin-top: 14px;
        }
    </style>